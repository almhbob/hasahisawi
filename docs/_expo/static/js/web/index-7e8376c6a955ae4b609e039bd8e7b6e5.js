__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  var _firebaseAppCheck = require(_dependencyMap[0]);
  Object.keys(_firebaseAppCheck).forEach(function (k) {
    if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) {
      Object.defineProperty(exports, k, {
        enumerable: true,
        get: function () {
          return _firebaseAppCheck[k];
        }
      });
    }
  });
...
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  Object.defineProperty(exports, "ReCaptchaEnterpriseProvider", {
    enumerable: true,
    get: function () {
      return ReCaptchaEnterpriseProvider;
    }
  });
  Object.defineProperty(exports, "ReCaptchaV3Provider", {
    enumerable: true,
    get: function () {
      return ReCaptchaV3Provider;
    }
  });
  Object.defineProperty(exports, "getLimitedUseToken", {
    enumerable: true,
    get: function () {
  ...
  Object.defineProperty(exports, "initializeAppCheck", {
    enumerable: true,
    get: function () {
      return initializeAppCheck;
    }
  });
  Object.defineProperty(exports, "onTokenChanged", {
    enumerable: true,
    get: function () {
      return onTokenChanged;
    }
  });
  Object.defineProperty(exports, "setTokenAutoRefreshEnabled", {
    enumerable: true,
    get: function () {
      return setTokenAutoRefreshEnabled;
    }
  });
  var _firebaseApp = require(_dependencyMap[0]);
  var _firebaseComponent = require(_dependencyMap[1]);
  var _firebaseUtil = require(_dependencyMap[2]);
  var _firebaseLogger = require(_dependencyMap[3]);
  /**
   * @license
  ...
  class Refresher {
    ...
    async process(hasSucceeded) {
      this.stop();
      try {
        this.pending = new _firebaseUtil.Deferred();
  ...
  const ERROR_FACTORY = new _firebaseUtil.ErrorFactory('appCheck', 'AppCheck', ERRORS);
   ...
   * limitations under the License.
   */
  const logger = new _firebaseLogger.Logger('@firebase/app-check');
  ...
  function initializeDebugMode() {
    const globals = (0, _firebaseUtil.getGlobal)();
    const debugState = getDebugState();
    ...
    const deferredToken = new _firebaseUtil.Deferred();
  ...
  function formatDummyToken(tokenErrorData) {
    return _firebaseUtil.base64.encodeString(JSON.stringify(tokenErrorData), /* webSafe= */false);
  }
  /**
  ...
  function createTokenRefresher(appCheck) {
    ...
    async () => {
      ...
      if (state.token) {
        ...
        let nextRefreshTimeMillis = state.token.issuedAtTimeMillis + (state.token.expireTimeMillis - state.token.issuedAtTimeMillis) * 0.5 + 300000;
        // Do not allow refresh time to be past (expireTime - 5 minutes)
        const latestAllowableRefresh = state.token.expireTimeMillis - 300000;
  ...
  function initializeV3(app, siteKey) {
    const initialized = new _firebaseUtil.Deferred();
    const state = getStateReference(app);
  ...
  class ReCaptchaV3Provider {
    ...
    initialize(app) {
      this._app = app;
      this._heartbeatServiceProvider = (0, _firebaseApp._getProvider)(app, 'heartbeat');
  ...
  class CustomProvider {
    ...
    async getToken() {
      ...
      const issuedAtTimeSeconds = (0, _firebaseUtil.issuedAtTime)(customToken.token);
  ...
  function setBackoff(httpStatus, throttleData) {
    ...
    if (httpStatus === 404 || httpStatus === 403) {
      ...
      const backoffMillis = (0, _firebaseUtil.calculateBackoffMillis)(backoffCount, 1000, 2);
      return {
   ...
   * @public
   */
  function initializeAppCheck(app = (0, _firebaseApp.getApp)(), options) {
    app = (0, _firebaseUtil.getModularInstance)(app);
    const provider = (0, _firebaseApp._getProvider)(app, 'app-check');
  ...
  function registerAppCheck() {
    ...
    (0, _firebaseApp._registerComponent)(new _firebaseComponent.Component(APP_CHECK_NAME, container => {
    ...
    (0, _firebaseApp._registerComponent)(new _firebaseComponent.Component(APP_CHECK_NAME_INTERNAL, container => {
