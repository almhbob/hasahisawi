...
mustContain('function ServiceGridItem', 'Home service grid component was not found.');
mustContain('const SERVICES = useMemo', 'Home services list was not found.');
...
if (changed) {
  ...
  console.log('Home services UI fix already applied or source uses a newer layout.');
}
