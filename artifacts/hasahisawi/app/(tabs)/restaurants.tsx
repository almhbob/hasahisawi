  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 130 }}>
        <ModernHeader title="المطاعم والكافتريات" subtitle="مؤسسات · منيو مصور · أسعار · سلة · كاشير · فواتير · تقارير مبيعات" icon="restaurant-outline">
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: Colors.bg }, body: { padding: 18, gap: 14 },
  tabs: { flexDirection: "row-reverse", gap: 8 }, tab: { flex: 1, minHeight: 42, borderRadius: Colors.radius.md, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 5, ...Colors.shadow.card }, tabOn: { backgroundColor: Colors.primary, borderColor: Colors.primary }, tabText: { fontFamily: "Cairo_700Bold", color: Colors.textSecondary, fontSize: 11 },
  searchBox: { height: 48, borderRadius: Colors.radius.md, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 8 }, input: { flex: 1, color: Colors.textPrimary, fontFamily: "Cairo_400Regular", textAlign: "right" }, filterRow: { gap: 8, paddingVertical: 2 }, filterChip: { flexDirection: "row", gap: 6, alignItems: "center", borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, paddingHorizontal: 12, paddingVertical: 8, borderRadius: Colors.radius.pill }, businessChip: { borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, paddingHorizontal: 12, paddingVertical: 8, borderRadius: Colors.radius.pill }, businessChipOn: { backgroundColor: Colors.primary, borderColor: Colors.primary }, filterText: { fontFamily: "Cairo_600SemiBold", color: Colors.textSecondary, fontSize: 12 },
  card: { backgroundColor: Colors.surface, borderRadius: Colors.radius.lg, borderWidth: 1, borderColor: Colors.border, padding: 14, gap: 12, ...Colors.shadow.card }, productTop: { flexDirection: "row-reverse", gap: 12, alignItems: "center" }, foodImg: { width: 86, height: 86, borderRadius: Colors.radius.lg, alignItems: "center", justifyContent: "center" }, name: { fontFamily: "Cairo_700Bold", color: Colors.textPrimary, fontSize: 16, textAlign: "right" }, meta: { fontFamily: "Cairo_400Regular", color: Colors.textMuted, fontSize: 11, textAlign: "right", marginTop: 2 }, desc: { fontFamily: "Cairo_400Regular", color: Colors.textSecondary, fontSize: 12, textAlign: "right", marginTop: 4 }, actions: { flexDirection: "row-reverse", alignItems: "center", justifyContent: "space-between", gap: 10 }, price: { fontFamily: "Cairo_700Bold", fontSize: 15 }, callBtn: { flexDirection: "row", gap: 6, alignItems: "center", backgroundColor: Colors.primary, paddingHorizontal: 16, paddingVertical: 9, borderRadius: Colors.radius.md }, callText: { fontFamily: "Cairo_700Bold", color: "#001", fontSize: 12 },
  cashierHead: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", gap: 12 }, sectionTitle: { fontFamily: "Cairo_700Bold", color: Colors.textPrimary, fontSize: 17, textAlign: "right" }, muted: { fontFamily: "Cairo_400Regular", color: Colors.textMuted, fontSize: 12, textAlign: "right" }, addBtn: { flexDirection: "row", gap: 6, alignItems: "center", backgroundColor: Colors.primary, paddingHorizontal: 12, paddingVertical: 9, borderRadius: Colors.radius.md }, addText: { fontFamily: "Cairo_700Bold", color: "#001", fontSize: 12 }, grid: { flexDirection: "row-reverse", flexWrap: "wrap", gap: 10 }, quickItem: { width: "47%", borderRadius: Colors.radius.md, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, padding: 12, gap: 6, ...Colors.shadow.card }, quickName: { flex: 1, fontFamily: "Cairo_700Bold", color: Colors.textPrimary, textAlign: "right" }, quickPrice: { fontFamily: "Cairo_700Bold", color: Colors.primary },
  cartBox: { backgroundColor: Colors.surface, borderRadius: Colors.radius.lg, borderWidth: 1, borderColor: Colors.border, padding: 14, gap: 10, ...Colors.shadow.card }, cartLine: { flexDirection: "row-reverse", alignItems: "center", gap: 8, borderBottomWidth: 1, borderColor: Colors.border, paddingVertical: 7 }, cartFooter: { flexDirection: "row-reverse", justifyContent: "space-between", alignItems: "center", paddingTop: 8 }, cartTitle: { fontFamily: "Cairo_700Bold", color: Colors.textPrimary }, cartTotal: { fontFamily: "Cairo_700Bold", color: Colors.primary, fontSize: 16 }, checkoutRow: { flexDirection: "row-reverse", gap: 8 }, checkout: { backgroundColor: "#22C55E", borderRadius: Colors.radius.sm, paddingHorizontal: 12, paddingVertical: 9, alignItems: "center" }, checkoutText: { fontFamily: "Cairo_700Bold", color: "#001", fontSize: 12 }, floatingCart: { position: "absolute", left: 14, right: 14, bottom: 18, backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, borderRadius: Colors.radius.lg, padding: 12, flexDirection: "row-reverse", alignItems: "center", gap: 10, ...Colors.shadow.raised },
  invoiceCard: { backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, borderRadius: Colors.radius.lg, padding: 14, gap: 5, ...Colors.shadow.card }, invoiceNo: { fontFamily: "Cairo_700Bold", color: Colors.textPrimary, textAlign: "right" }, invoiceMeta: { fontFamily: "Cairo_400Regular", color: Colors.textMuted, textAlign: "right", fontSize: 12 }, invoiceTotal: { fontFamily: "Cairo_700Bold", color: Colors.primary, textAlign: "right" }, reportBtns: { flexDirection: "row-reverse", gap: 8 }, reportBtn: { flex: 1, borderRadius: Colors.radius.md, borderWidth: 1, borderColor: Colors.border, paddingVertical: 10, alignItems: "center" }, reportBtnOn: { backgroundColor: Colors.primary, borderColor: Colors.primary }, reportText: { fontFamily: "Cairo_700Bold", color: Colors.textSecondary }, reportCard: { backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, borderRadius: Colors.radius.lg, padding: 14, gap: 12, ...Colors.shadow.card }, kpis: { flexDirection: "row-reverse", gap: 8 }, kpi: { flex: 1, backgroundColor: Colors.bgAlt, borderRadius: Colors.radius.md, padding: 10, alignItems: "center" }, kpiValue: { fontFamily: "Cairo_700Bold", color: Colors.primary, fontSize: 14 }, topRow: { flexDirection: "row-reverse", alignItems: "center", gap: 8, paddingVertical: 6 }, empty: { alignItems: "center", justifyContent: "center", padding: 40, gap: 8 },
  modalBg: { flex: 1, backgroundColor: "#0009", justifyContent: "flex-end" }, modal: { backgroundColor: Colors.bg, borderTopLeftRadius: Colors.radius.xl, borderTopRightRadius: Colors.radius.xl, padding: 18, gap: 10, borderWidth: 1, borderColor: Colors.border, maxHeight: "88%" }, imagePick: { minHeight: 110, borderRadius: Colors.radius.lg, borderWidth: 1, borderColor: Colors.border, borderStyle: "dashed", backgroundColor: Colors.surface, alignItems: "center", justifyContent: "center", padding: 10 }, pickThumb: { width: 88, height: 88, borderRadius: Colors.radius.md }, modalInput: { minHeight: 46, borderRadius: Colors.radius.md, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, paddingHorizontal: 12, color: Colors.textPrimary, fontFamily: "Cairo_400Regular", textAlign: "right" }, modalActions: { flexDirection: "row-reverse", gap: 10 }, cancelBtn: { flex: 1, height: 46, borderRadius: Colors.radius.md, borderWidth: 1, borderColor: Colors.border, alignItems: "center", justifyContent: "center" }, saveBtn: { flex: 1, height: 46, borderRadius: Colors.radius.md, backgroundColor: Colors.primary, alignItems: "center", justifyContent: "center" }, saveText: { fontFamily: "Cairo_700Bold", color: "#001" },
});
