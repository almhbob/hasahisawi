...
const EVENTS: Event[] = [
  ...
  { id: "e4", orgId: "o5", orgName: "مبادرة بنات الحصاحيصا", title: "معرض الحرف اليدوية", date: "الجمعة 4 أبريل 2026", location: "قاعة المدينة الثقافية", description: "معرض لعرض منتجات المرأة الحصاحيصاوية للبيع", color: "#A855F7" },
];
...
const CAMPAIGNS: Campaign[] = [
  ...
  { id: "c3", orgId: "o5", orgName: "مبادرة بنات الحصاحيصا", title: "ماكينات خياطة للأسر", target: "30,000 جنيه", description: "شراء 10 ماكينات خياطة لتوزيعها على الأسر الفقيرة لتوليد دخل", icon: "needle", color: "#A855F7" },
];
