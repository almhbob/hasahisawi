  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(39,174,104,0.3) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      ...
      <div style={{
        ...
        borderRadius: 30, padding: "6px 24px",
        fontSize: 12, color: "#fff", fontWeight: 800, letterSpacing: 3,
        textTransform: "uppercase", zIndex: 10,
        boxShadow: "0 4px 20px rgba(39,174,104,0.5)",
      }}>
        🚀 تحديث جديد
      </div>
      ...
      <div style={{
        ...
        textAlign: "center", direction: "rtl", padding: "0 40px",
      }}>

        {/* Logo */}
        <div style={{
          width: 90, height: 90, borderRadius: 22, overflow: "hidden",
          boxShadow: "0 0 0 3px rgba(39,174,104,0.3), 0 0 40px rgba(39,174,104,0.4)",
          marginBottom: 18,
        }}>
        ...
        {/* Version badge */}
        <div style={{
          background: "rgba(39,174,104,0.12)",
          border: "1px solid rgba(39,174,104,0.35)",
          borderRadius: 20, padding: "4px 18px",
          fontSize: 12, color: "#3EFF9C", fontWeight: 700,
        ...
        {/* Improvements row */}
        <div style={{
          display: "flex", gap: 10, marginBottom: 24, width: "100%", justifyContent: "center",
        }}>
          {["✅ أداء أسرع", "✅ استقرار أعلى", "✅ تجربة أفضل"].map((t, i) => (
            <div key={i} style={{
              ...
              fontSize: 11, color: "rgba(255,255,255,0.65)", flex: 1, textAlign: "center",
            }}>
              {t}
            </div>
          ))}
        ...
        <div style={{
          width: "100%",
          background: "linear-gradient(135deg, #27AE68, #1E8A50)",
      ...
      <div style={{
        ...
        {["#حصاحيصاوي", "#حصاحيصا", "#تحديث_جديد"].map((t, i) => (
          <span key={i} style={{
            ...
            border: "1px solid rgba(39,174,104,0.15)",
