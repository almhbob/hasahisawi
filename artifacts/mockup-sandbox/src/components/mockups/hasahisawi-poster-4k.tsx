export default function HasahisawiPoster4K() {
  const SCALE = 3;
  const W = 540, H = 960;

  return (
    <div style={{ width: W * SCALE, height: H * SCALE, overflow: "hidden", background: "#0B1F14" }}>
      <div style={{ transform: `scale(${SCALE})`, transformOrigin: "top left", width: W, height: H }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: "28px 36px 0", boxSizing: "border-box", position: "relative", zIndex: 10,
          }}>
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.35)", letterSpacing: 3, textTransform: "uppercase" }}>
              Hasahisa · Sudan
            </div>
            <div style={{
              background: "linear-gradient(135deg, #27AE68, #1a7a4a)", borderRadius: 20,
              padding: "5px 16px", fontSize: 11, color: "#fff", fontWeight: 700, letterSpacing: 1,
            }}>
          ...
          {/* Logo */}
          <div style={{ position: "relative", zIndex: 10, marginTop: 40, marginBottom: 8 }}>
            <div style={{
            ...
            <div style={{ position: "absolute", inset: -12, borderRadius: 44, border: "1.5px solid rgba(39,174,104,0.3)", pointerEvents: "none" }} />
            <div style={{ position: "absolute", inset: -24, borderRadius: 56, border: "1px solid rgba(39,174,104,0.12)", pointerEvents: "none" }} />
          </div>

          {/* App name */}
          <div style={{ position: "relative", zIndex: 10, textAlign: "center", marginTop: 22, direction: "rtl" }}>
            <div style={{
              fontSize: 52, fontWeight: 900, color: "#FFFFFF", lineHeight: 1, letterSpacing: -1,
              textShadow: "0 0 40px rgba(39,174,104,0.5)", marginBottom: 8,
            }}>
              حصاحيصاوي
            </div>
            <div style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", letterSpacing: 5, textTransform: "uppercase" }}>
              H A S A H I S A W I
            </div>
          </div>
          ...
          {/* Divider */}
          <div style={{
            position: "relative", zIndex: 10, width: 280, height: 2, margin: "24px auto",
            background: "linear-gradient(90deg, transparent, #27AE68 30%, #F0A500 70%, transparent)", borderRadius: 2,
          }} />

          {/* Tagline */}
          <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 44px", direction: "rtl", marginBottom: 32 }}>
            <div style={{ fontSize: 22, fontWeight: 700, color: "#FFFFFF", lineHeight: 1.6, marginBottom: 10 }}>
              البوابة الذكية<br />
          ...
          {/* Services grid */}
          <div style={{
            position: "relative", zIndex: 10, display: "grid", gridTemplateColumns: "1fr 1fr 1fr",
            gap: 12, padding: "0 28px", width: "100%", boxSizing: "border-box", marginBottom: 28,
          }}>
            {[
              ...
              <div key={i} style={{
                ...
                borderRadius: 16, padding: "18px 10px", textAlign: "center", backdropFilter: "blur(10px)",
              }}>
          ...
          {/* Stats strip */}
          <div style={{
            position: "relative", zIndex: 10, display: "flex", justifyContent: "space-around",
            width: "calc(100% - 56px)", background: "rgba(39,174,104,0.1)",
            border: "1px solid rgba(39,174,104,0.2)", borderRadius: 20, padding: "18px 20px",
          ...
          <div style={{
            ...
            border: "1px solid rgba(240,165,0,0.4)", borderRadius: 16,
            padding: "14px 28px", marginBottom: 28, direction: "rtl", textAlign: "center",
          }}>
          ...
          {/* CTA */}
          <div style={{
            position: "relative", zIndex: 10, width: "calc(100% - 56px)",
            background: "linear-gradient(135deg, #27AE68 0%, #1E8A50 100%)",
            borderRadius: 20, padding: "20px", textAlign: "center",
            boxShadow: "0 12px 40px rgba(39,174,104,0.45)", direction: "rtl",
          }}>
