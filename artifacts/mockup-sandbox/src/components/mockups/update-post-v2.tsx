export default function UpdatePostV2() {
  return (
    <div style={{
      ...
      {/* Giant version number — background watermark */}
      <div style={{
        position: "absolute",
        top: -30, left: -20,
      ...
      <div style={{
        ...
        padding: "32px 36px 24px", boxSizing: "border-box",
        direction: "rtl",
      }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{
              ...
              boxShadow: "0 0 20px rgba(39,174,104,0.5)",
              flexShrink: 0,
            }}>
          ...
          <div style={{
            background: "rgba(39,174,104,0.15)",
            border: "1px solid #27AE68",
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 16 }}>
          {["#حصاحيصاوي", "#حصاحيصا", "#تحديث_جديد"].map((t, i) => (
            <span key={i} style={{
              fontSize: 10, color: "rgba(39,174,104,0.55)",
            }}>{t}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        height: 2,
        background: "linear-gradient(90deg, transparent, #27AE68 50%, transparent)",
        zIndex: 10,
      }} />
    </div>
  );
